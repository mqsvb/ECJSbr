...
SetModifier(cmd1, 1, "Steel Blue|8"); 
...
AskDigInfo("Pick Edges", gdh1, _ENTITYDIG, 164, "", false);
// Finish input
...
AskDigInfo("Pick 2nd Vertex ", gdh1, _ENTITYDIG, 165, "", false);
// Finish input
AddFinishDig(gdh1, _FINISH); 
