...
//Custom dialog real box realVar 
		...
		function AskCdWire(){
			SetPCIVariable("_levelcdvar", "18");
			SetPCIVariable("_startvar", "20");
			SetPCIVariable("_endvar", "-");

			nRet = AskBox(["Digite Level", "START", "END"], ["_levelcdvar", "_startvar", "_endvar"]);
		// Get the PCI variables set by the AskBox (required)
		var rVar            = GetPCIVariable("_levelcdvar"); 
		var rcutVar         = GetPCIVariable("_startvar"); 
		var rcut2Var        = GetPCIVariable("_endvar"); 
...
AskCdWire();    
		...
		if (nRet!=-3) { 
           	...
           	Display("Operação CDWire Cancelada\\");
		return;
...
SetModifier(cmd0, 125, "19");
// Setting modifier 'Layer'
SetModifier(cmd0, 126, "99|1");
...
SetModifier(cmd0, 273, "2020-11-17 12:02:49");
// Setting modifier 'Time TS Tool'
SetModifier(cmd0, 274, "2020-11-17 12:02:49");
...
SetModifier(cmd0, 161, "[_levelcdvar]");
// Setting modifier 'Depth'
...
SetModifier(cmd0, 117, "[_startvar]");
// Setting modifier 'End'
SetModifier(cmd0, 118, "[_endvar]");
