...
SetModifier(cmd0, 180, "MLD-191");
// Setting modifier 'Mount Description'
SetModifier(cmd0, 269, "MAC");
// Setting modifier 'Position'
SetModifier(cmd0, 48, "1");
// Setting modifier 'Group Code'
SetModifier(cmd0, 16, "MAC-PEDIDO 39884");
// Setting modifier 'Code ID'
SetModifier(cmd0, 17, "74915 - FRESA MOLDURA HW CFE DES 014.01-23-191,3X42,4X30-8Z");
// Setting modifier 'Diameter'
SetModifier(cmd0, 47, "191.34");
...
SetModifier(cmd0, 179, "42.4");
// Setting modifier 'Number of Teeth'
SetModifier(cmd0, 130, "8");
...
SetModifier(cmd0, 170, "23000764.meg");
// Setting modifier 'Holder Graphic^Browse...'
SetModifier(cmd0, 171, "CONE_TUPIAS.meg");
...
SetModifier(cmd0, 271, "7371");
// Setting modifier 'Time TS Mount'
SetModifier(cmd0, 273, "2023-03-16 13:07:44");
// Setting modifier 'Time TS Tool'
SetModifier(cmd0, 274, "2023-03-16 13:07:44");
...
SetModifier(cmd0, 28, "20");
// Setting modifier 'Level'
SetModifier(cmd0, 161, "18");
// Setting modifier 'Depth'
SetModifier(cmd0, 9, "-48.8");
// Setting modifier 'Cut Increment'
SetModifier(cmd0, 10, "70");
