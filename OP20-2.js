...
SetPackage(1);
		...
		SetPCIVariable("_comprimento", "");		
		nret = AskBox(["Comprimento rasgo: "], ["_comprimento"]);

		// Get the PCI variables set by the AskBox (required)
		var comprimentovar = GetPCIVariable("_comprimento"); 
		
		if (nret!=-3) { 
			Display("Operação OP20-2 Cancelada\\");
			return 0;
		}
...
// Setting modifier 'Depth Type'
SetModifier(cmd0, 138, "Full Diameter|1");
...
SetModifier(cmd0, 273, "2021-05-19 10:12:28");
// Setting modifier 'Time TS Tool'
SetModifier(cmd0, 274, "2021-05-19 10:12:28");
nRet = ExecCommand(cmd0, -1);


// Initialising command:- Profiling climmb
...
SetModifier(cmd0, 118, "-[_comprimento]/2+15"); 
...
// Initialising command:- Profiling conventional
cmd0 = InitCommand(22, 110);
ClearMods(cmd0);
// Setting modifier 'Disallow CRC Geometry with Taper'
SetModifier(cmd0, 365, "1");
