...
SetModifier(cmd0, 270, "Provider=SQLNCLI11;Password=y74rvpy2d24atkpbkd_c2sbcu;User ID=toolstore_user;DataTypeCompatibility=80;server=LANTEK\\ECSQLEXPRESS;database=DB_EC2022");
...
// Setting modifier 'Comment'
SetModifier(cmd0, 295, "* * * * * * * FIVE AXIS 1/2");
...
// Setting modifier 'Side Tilt Fanning Dist'
SetModifier(cmd0, 66, "0");
...
SetModifier(cmd0, 189, "Radius Horizontal to Tool Axis|2");
...
SetModifier(cmd0, 155, "0");
// Setting modifier 'Comment'
SetModifier(cmd0, 295, "* * * * * * * FIVE AXIS 2/2");
// Setting modifier 'Tolerance'
SetModifier(cmd0, 24, "0.01");
// Setting modifier 'Depth'
SetModifier(cmd0, 85, "");
