...
ClearMods(cmd0);
SetModifier(cmd0, 199, "tmc-01_DESB0.3+FLAT");
...
SetModifier(cmd0, 180, "ELI-10");
// Setting modifier 'Mount Description'
SetModifier(cmd0, 269, "10mm LISA");
// Setting modifier 'Position'
SetModifier(cmd0, 48, "9");
// Setting modifier 'Code ID'
SetModifier(cmd0, 17, "35431 - FRESA HELICOIDAL LISA MD 10X32X80MM 3C");
// Setting modifier 'Comment'
SetModifier(cmd0, 15, "ELI-10");
...
SetModifier(cmd0, 271, "207");
// Setting modifier 'Time TS Mount'
SetModifier(cmd0, 273, "2024-01-30 09:13:38");
// Setting modifier 'Time TS Tool'
SetModifier(cmd0, 274, "2024-01-30 09:13:38");
nRet = AskMods(cmd0);
if (nRet != _FINISH)
{
	return 0;
...
SetModifier(cmd0, 117, "2");
// Setting modifier 'End'
SetModifier(cmd0, 118, "2");
