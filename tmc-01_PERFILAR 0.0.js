...
ClearMods(cmd0);
SetModifier(cmd0, 199, "tmc-01_PERFILAR 0.0");
...
SetModifier(cmd0, 125, "14|14");
// Setting modifier 'Layer'
SetModifier(cmd0, 126, "Geometry|3");
...
SetModifier(cmd0, 35, "0.0");
// Setting modifier 'Tolerance'
SetModifier(cmd0, 62, "0.05");
// Setting modifier 'Comment'
SetModifier(cmd0, 295, "ACABA 0.0");
