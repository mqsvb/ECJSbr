...
ClearMods(cmd0);
SetModifier(cmd0, 199, "tmc-02_PROF 0.0");
...
SetModifier(cmd0, 273, "2024-02-27 13:26:06");
// Setting modifier 'Time TS Tool'
SetModifier(cmd0, 274, "2024-02-27 13:26:06");
nRet = AskMods(cmd0);
if (nRet != _FINISH)
{
	return 0;
...
// Setting modifier 'Comment'
SetModifier(cmd0, 295, "ACABA REB CH 0.0");
